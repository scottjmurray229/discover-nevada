...
heroImage: ""
heroAlt: "Silver-mining era storefronts and boardwalks of Virginia City, Nevada"
...
budgetPerDay:
  ...
  midRange: 90
  luxury: 220
gettingThere: "Drive southeast from Reno on I-580 to US-341, about 30 miles. From Carson City, take US-50 East to SR-341 North, roughly 14 miles."
essentials:
  - { icon: "🌡️", label: "Climate", value: "Desert / arid" }
  - { icon: "💵", label: "Budget", value: "$35-220/day" }
  - { icon: "🗣️", label: "Language", value: "English" }
highlights:
  - "Walk the authentic boardwalks of C Street and explore Victorian-era saloons still pouring drinks"
  - "Descend into a real Comstock-era mine on a guided underground tour"
  - "Ride the Virginia & Truckee Railroad through the historic mining landscape"
gradientColors: "from-yellow-900 via-amber-800 to-orange-900"
relatedDestinations:
  - "carson-city"
  - "great-basin"
faqItems:
