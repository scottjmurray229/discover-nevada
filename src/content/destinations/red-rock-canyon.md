...
budgetPerDay:
  ...
  midRange: 70
  luxury: 180
gettingThere: "Drive west from the Las Vegas Strip via Charleston Boulevard (NV-159). The visitor center is approximately 17 miles from the Strip, about 30 minutes without traffic."
essentials:
  - { icon: "🌡️", label: "Climate", value: "Desert / arid" }
  - { icon: "💵", label: "Budget", value: "$25-180/day" }
  - { icon: "🗣️", label: "Language", value: "English" }
highlights:
  - "Drive the 13-mile one-way scenic loop through towering red and cream sandstone formations"
  - "Hike to the Calico Tanks for panoramic views stretching all the way to the Las Vegas Strip"
  - "Watch world-class rock climbers tackle over 3,000 routes on the canyon's dramatic walls"
gradientColors: "from-rose-900 via-red-800 to-orange-900"
relatedDestinations:
  - "las-vegas"
  - "valley-of-fire"
faqItems:
