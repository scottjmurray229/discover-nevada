...
budgetPerDay:
  ...
  midRange: 250
  luxury: 800
gettingThere: "Fly into Harry Reid International Airport (LAS), located just minutes from the Strip. Drive via I-15 from Los Angeles (4 hours) or from Salt Lake City (6 hours)."
essentials:
  - { icon: "🌡️", label: "Climate", value: "Desert / arid" }
  - { icon: "💵", label: "Budget", value: "$60-800/day" }
  - { icon: "🗣️", label: "Language", value: "English" }
highlights:
  - "Walk the four-mile Las Vegas Strip lined with mega-resorts and iconic landmarks"
  - "Experience the vibrant Fremont Street light show and vintage downtown charm"
  - "Catch world-class entertainment from Cirque du Soleil to headline residencies"
