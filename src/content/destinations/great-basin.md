...
heroImage: ""
tagline: "Where ancient trees meet infinite skies"
region: "western"
...
budgetPerDay:
  ...
  midRange: 100
  luxury: 250
gettingThere: "Drive east on US-50 from Reno (approximately 385 miles) or west from Salt Lake City (about 235 miles) via US-93 South and US-50 West to Baker, NV."
essentials:
  - { icon: "🌡️", label: "Climate", value: "Desert / alpine" }
  - { icon: "💵", label: "Budget", value: "$40-250/day" }
  - { icon: "🗣️", label: "Language", value: "English" }
highlights:
  - "Tour the marble halls of Lehman Caves with a ranger-led underground expedition"
  - "Summit Wheeler Peak at 13,063 feet for jaw-dropping views of the Great Basin"
  - "Stand among bristlecone pines that have lived for over 5,000 years"
