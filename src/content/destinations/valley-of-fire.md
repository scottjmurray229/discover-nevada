...
heroImage: ""
tagline: "Ancient Sandstone Sculpted by Time"
region: "southern"
...
budgetPerDay:
  ...
  midRange: 80
  luxury: 200
gettingThere: "Drive northeast from Las Vegas via I-15 and exit at Valley of Fire Highway (NV-169). The park entrance is approximately 50 miles from the Strip, about one hour of driving."
essentials:
  - { icon: "🌡️", label: "Climate", value: "Desert / arid" }
  - { icon: "💵", label: "Budget", value: "$30-200/day" }
  - { icon: "🗣️", label: "Language", value: "English" }
highlights:
  - "Hike the Fire Wave trail to witness swirling bands of red, pink, and white sandstone"
  - "Discover 3,000-year-old petroglyphs carved by ancient Puebloan peoples at Atlatl Rock"
  - "Photograph the dramatic White Domes and Elephant Rock formations at golden hour"
gradientColors: "from-red-900 via-orange-800 to-amber-900"
relatedDestinations:
  - "las-vegas"
  - "red-rock-canyon"
faqItems:
