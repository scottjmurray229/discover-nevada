...
budgetPerDay:
  ...
  midRange: 150
  luxury: 400
gettingThere: "Fly into Reno-Tahoe International Airport (RNO), located just minutes from downtown. Drive via I-80 from Sacramento (2.5 hours) or from San Francisco (4 hours)."
essentials:
  - { icon: "🌡️", label: "Climate", value: "Semi-arid / four seasons" }
  - { icon: "💵", label: "Budget", value: "$50-400/day" }
  - { icon: "🗣️", label: "Language", value: "English" }
highlights:
  - "Stroll the Riverwalk District along the scenic Truckee River through the heart of downtown"
  - "Tour the National Automobile Museum and its world-class collection of over 200 vintage vehicles"
  - "Experience the reinvented Midtown district packed with craft breweries, restaurants, and murals"
gradientColors: "from-blue-900 via-sky-800 to-cyan-900"
relatedDestinations:
  - "lake-tahoe"
  - "las-vegas"
faqItems:
