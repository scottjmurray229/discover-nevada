...
budgetPerDay:
  ...
  midRange: 100
  luxury: 250
gettingThere: "From Las Vegas, take I-11 South (previously US-93) for about 25 miles. Boulder City is roughly 30 minutes southeast of the Strip and 10 minutes from Hoover Dam."
essentials:
  - { icon: "🌡️", label: "Climate", value: "Desert / arid" }
  - { icon: "💵", label: "Budget", value: "$35-250/day" }
  - { icon: "🗣️", label: "Language", value: "English" }
highlights:
  - "Stand on top of Hoover Dam and peer 726 feet down into Black Canyon"
  - "Kayak the emerald waters of the Colorado River below the dam through Black Canyon"
  - "Explore the charming antique shops and restaurants along Boulder City's historic downtown strip"
gradientColors: "from-stone-900 via-amber-800 to-yellow-900"
relatedDestinations:
  - "henderson"
  - "great-basin"
faqItems:
