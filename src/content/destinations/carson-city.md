...
budgetPerDay:
  ...
  midRange: 120
  luxury: 300
gettingThere: "Carson City is 30 miles south of Reno via US-395. From Lake Tahoe's south shore, take US-50 East over Spooner Summit, about 25 miles and 35 minutes."
essentials:
  - { icon: "🌡️", label: "Climate", value: "Desert / semi-arid" }
  - { icon: "💵", label: "Budget", value: "$40-300/day" }
  - { icon: "🗣️", label: "Language", value: "English" }
highlights:
  - "Walk the Kit Carson Trail through 2.5 miles of historic Victorian homes and landmarks"
  - "Explore the Nevada State Museum, home to a full-size replica mine and the famous Carson City Mint coin collection"
  - "Ride the restored Virginia & Truckee Railway between Carson City and Virginia City through mountain scenery"
gradientColors: "from-indigo-900 via-purple-800 to-violet-900"
relatedDestinations:
  - "virginia-city"
  - "great-basin"
faqItems:
