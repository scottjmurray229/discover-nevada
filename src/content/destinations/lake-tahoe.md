...
budgetPerDay:
  ...
  midRange: 200
  luxury: 600
gettingThere: "Fly into Reno-Tahoe International Airport (RNO) and drive 45 minutes southwest via US-395 and NV-431 (Mt. Rose Highway). From Sacramento, take US-50 east for approximately 2 hours."
essentials:
  - { icon: "🌡️", label: "Climate", value: "Alpine / four seasons" }
  - { icon: "💵", label: "Budget", value: "$60-600/day" }
  - { icon: "🗣️", label: "Language", value: "English" }
highlights:
  - "Gaze into the impossibly clear waters of North America's largest alpine lake"
  - "Ski world-class resorts like Palisades Tahoe and Diamond Peak in winter"
  - "Hike to Emerald Bay and photograph one of the most iconic vistas in the American West"
gradientColors: "from-cyan-900 via-blue-800 to-indigo-900"
relatedDestinations:
  - "reno"
  - "las-vegas"
faqItems:
